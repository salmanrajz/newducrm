                        ...
                        <div class="row">
                                ...
                                <div class="mb-1">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="date" id="activation_date" class="form-control" name="activation_date"
                                            value="{{ \Carbon\Carbon::parse($data->activation_date)->format('Y-m-d')}}" />
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="mb-1">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="date" id="status" class="form-control" name="fbd_billing_date"
                                            value="{{ \Carbon\Carbon::parse($data->fbd_billing_date)->format('Y-m-d')}}" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="mb-1">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="date" id="status" class="form-control" name="fbd_21"
                                            value="{{ \Carbon\Carbon::parse($data->fbd_21)->format('Y-m-d')}}" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="mb-1">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="date" id="status" class="form-control" name="fbd_90"
                                            value="{{ \Carbon\Carbon::parse($data->fbd_90)->format('Y-m-d')}}" />
                                    </div>
                                </div>
                            </div>
                             <div class="col-12">
                                ...
                                <div class="mb-1">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="date" id="status" class="form-control" name="sbd_billing_date"
                                            value="{{ \Carbon\Carbon::parse($data->sbd_billing_date)->format('Y-m-d')}}" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="mb-1">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="date" id="status" class="form-control" name="sbd_21"
                                            value="{{ \Carbon\Carbon::parse($data->sbd_21)->format('Y-m-d')}}" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="mb-1">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="date" id="status" class="form-control" name="sbd_90"
                                            value="{{ \Carbon\Carbon::parse($data->sbd_90)->format('Y-m-d')}}" />
                                    </div>
                                </div>
                            </div>
                             <div class="col-12">
                                ...
                                <div class="mb-1">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="date" id="status" class="form-control" name="tbd_billing_date"
                                            value="{{ \Carbon\Carbon::parse($data->tbd_billing_date)->format('Y-m-d')}}" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="mb-1">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="date" id="status" class="form-control" name="tbd_21"
                                            value="{{ \Carbon\Carbon::parse($data->tbd_21)->format('Y-m-d')}}" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="mb-1">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="date" id="status" class="form-control" name="tbd_90"
                                            value="{{ \Carbon\Carbon::parse($data->tbd_90)->format('Y-m-d')}}" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <button type="submit" class="btn btn-primary me-1"
                                    onclick="SavingActivationLead('{{ route('UpdateClawBack.post') }}', 'MyRoleForm','{{ route('ViewClawBack') }}')">Submit</button>
