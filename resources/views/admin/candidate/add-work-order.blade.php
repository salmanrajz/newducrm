                ...
                <div class="card-body">
                    <form class="form form-vertical" id="MyRoleForm" onsubmit="return false">
                        <div class="row">
                           ...
                           <div class="col-12">
                                <div class="mb-1">
                                    <label class="form-label" for="first-name-icon">Activity Date:</label>
                                    <div class="input-group input-group-merge">
                                        <span class="input-group-text"><i data-feather="user"></i></span>
                                        <input type="date" name="activity_date" id="activity_date" class="form-control"
                                        {{-- value="{{$data->activity_date}}" --}}
                                        value="{{$data->activity_date == '' ? 'NOT GENERATED YET' : $data->activity_date}}"
                           ...
                           <div class="col-12">
                                <div class="mb-1">
                                    <label class="form-label" for="first-name-icon">Work Order Date:</label>
                                    <div class="input-group input-group-merge">
                                        <span class="input-group-text"><i data-feather="user"></i></span>
                                        <input type="date" name="work_order_date" id="work_order_date" class="form-control"
                                        {{-- value="{{$data->work_order_date}}" --}}
                                        value="{{$data->work_order_date == '' ? 'NOT GENERATED YET' : $data->work_order_date}}"
                           ...
                           <div class="col-12">
                            ...
                            <div class="col-12">
                                <button type="submit" class="btn btn-success me-1"
                                    onclick="SavingActivationLead('{{ route('update.work.order') }}', 'MyRoleForm','{{ route('home') }}')">Submit</button>
