                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="question" id="long_description" cols="30" rows="10" class="form-control" ></textarea >
                                </div>
                            </div>
                            <hr>
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="long_description">Answer 1</label>
                                    <textarea name="answer1" id="answer1" cols="30" rows="10" class="form-control" ></textarea >
                                    <input type="radio" name="selected_answer" id="answer_1" value="1">
                            ...
                            <div class="col-12">
                                ...
                                <button type="button" class="btn btn-primary mr-1"
                                    {{-- onclick="VerifyLeadBlog('{{route('QuizAdd')}}','ClassesAdd','loadtable')" --}}
                                    onclick="VerifyLeadBlog('{{route('QuizAdd')}}', 'MyRoleForm','{{route('AllQuestionBank')}}')"
                                    >Submit</button>
