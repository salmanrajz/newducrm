              ...
              <tr>
                ...
                <td>
                 ...
                 <td class="product-action">
                        <span>
                                <i data-toggle="tooltip" title="Edit Data" data-feather='edit' onclick="PromotionEditData('{{$item->id}}', '{{route('edit.category.data')}}','category.index')"></i>
                        </span>
                        {{-- <i data-feather='trash'></i> --}}
                        <span>
                                <i data-toggle="tooltip" title="Delete Data" data-feather='trash' onclick="DeleteData('{{ $item->id }}','{{route('category.delete')}}')"></i>
                        </span>
              </td>
              </tr>
              @endforeach
    ...
    <div class="modal-dialog sidebar-sm">
      <form class="add-new-record modal-content pt-0" id="ClassesAdd" onsubmit="return false;">
        ...
        <div class="modal-body flex-grow-1" id="BoomBoom">
          ...
          {{--  --}}
          <button type="button" class="btn btn-primary data-submit mr-1" onclick="VerifyLead('{{route('category.create')}}','ClassesAdd','{{route('category.index')}}')">Submit</button>
