                        ...
                        <div class="col-2">
                             ...
                             <div class="col-3">
                                <div class="mb-1">
                                    ...
                                    <div class="input-group input-group-merge">
                                    <textarea name="address" id="address" cols="30" rows="10"  class="showme"  style="display: none">TYPE DOT HERE</textarea>
                                    </div>
                                </div>
                            </div>
                             <div class="col-1">
                                <div class="mb-1">
                                    ...
                                    onclick="SavingActivationLead('{{ route('SubmitEntry') }}', 'MyRoleForm','{{ route('AddEntryNew') }}')"
                                            >Submit</button>
                                </div>
                            </div>
                    </div>
