                ...
                <div class="card-body">
                    <form class="form form-vertical" id="MyRoleForm" onsubmit="return false">
                        ...
                        <div class="row">
                                ...
                                <div class="mb-1">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="tel" maxlength="10"
                                            ...
                                            value="{{$fne_data->customer_number}}"
                                            required />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="mb-1">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" name="address" id="address" class="form-control" required value="{{$fne_data->address}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
                            ...
                            <div class="col-12" id="fne_req_box" style="display: block">
                                <div class="mb-1">
                                    <label class="form-label" for="first-name-icon">FNE Request #</label>
                                    <div class="input-group input-group-merge">
                                        <span class="input-group-text"><i data-feather="user"></i></span>
                                        <input type="text" name="fne_req" value="{{$fne_data->id}}" class="form-control">
                            ...
                            <input type="hidden" name="saler_id" value="{{$fne_data->user_id}}">
                            ...
                            <div class="col-12">
                                <button type="submit" class="btn btn-primary me-1"
                                    onclick="SavingActivationLead('{{ route('FNESubmit') }}', 'MyRoleForm','{{ route('wifi.leads') }}')">Submit</button>
                            </div>
                        </div>
                    </form>
                </div>
