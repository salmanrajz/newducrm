...
<div class="col-12">
                ...
                @if($data->lead_type == 'P2P')
                    <div class="col-12">
                        <div class="mb-1">
                            ...
                            <div class="input-group input-group-merge">
                                <span class="input-group-text"><i data-feather="user"></i></span>
                                <input type="text" name="omid" id="omid" class="form-control" value="{{$data->remarks}}"
                                    autocomplete="false">
                            </div>
                        </div>
                    </div>
                ...
                @else
                    <div class="col-12">
                        <div class="mb-1">
                            ...
                            <div class="input-group input-group-merge">
                                <span class="input-group-text"><i data-feather="user"></i></span>
                                <input type="text" name="omid" id="omid" class="form-control"
                                    autocomplete="false" value="{{$data->omid}}">
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="mb-1">
                            ...
                            <div class="input-group input-group-merge">
                                <span class="input-group-text"><i data-feather="user"></i></span>
                                <input type="text" name="shipment" id="shipment" class="form-control"
                                    autocomplete="false" value="{{$data->shipment}}">
                            </div>
                        </div>
                    </div>
                     <div class="col-12">
                        <div class="mb-1">
                            <label class="form-label" for="first-name-icon">Active Screenshot:</label>
                            <div class="input-group input-group-merge">
                                <input type="file" name="activation_screenshot" id="additional_documents"
                                    class="form-control" accept="image/*">
                ...
                <div class="col-12">
                    ...
                    @else
                    <button type="submit" class="btn btn-primary me-1"
                    onclick="SavingActivationLead('{{ route('active.mnp') }}', 'MyRoleForm','{{ route('home') }}')">Submit
                    For Activation</button>
                    @endif
                    <button type="button" class="btn btn-danger me-1"
                        {{-- onclick="SavingActivationLead('{{ route('RejectLeads') }}', 'MyRoleForm'
                        ,'{{ route('home') }}')" --}} data-bs-toggle="modal"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <select name="reject_comment_new" id="reject_comment" class="form-control">
                                        ...
                                        <option value="Not Ported Succesfully" selected>Not Ported Succesfully</option>
