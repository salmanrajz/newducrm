    ...
    <div class="col-12">
      <div class="card container table">
        ...
        //
                        ...
                        @endphp
                        {{-- {{$item->reff_id}} --}}
                        <a href="https://shop.du.ae/en/order-tracking/searchOrderByMobile?orderCode={{$item->reff_id}}&mobile={{$output_str}}">
                        {{$item->reff_id}}
                        </a>
                    </td>
                    {{-- <td>{{$item->created_at}}</td> --}}
                    ...
                    <td>
                            ...
                            @endrole
                            @role('Sale|Admin|MainAdmin|Manager|TeamLeader')
                           <a href="{{route('view.lead',$item->id)}}" class="item-edit">
                                <i data-feather='eye'></i>
                            </a>
                            {{-- {{$item->status}} --}}
                            @if($item->status == 'Lead Reject' && $item->reff_id == '')
