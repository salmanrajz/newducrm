...
@section('title', 'First Bill Check')
          ...
          <tbody>
            ...
            <form class="form-horizontal form-label-left input_mask" method="post"
                ...
                <tr>
                    ...
                    <td>{{$item->contract_id}} - {{$item->account_id}}
                    <button id="testme" onclick="checkbill('{{route('CheckQuickPay')}}','bill','{{$key}}','{{$item->account_id}}')" class="btn btn-small btn-success">CHECK BILL</button>
                    ...
                    {{-- <td>{{$item->status}}</td> --}}
                    <td width="20%">
                        <label class="form-label" for="first-name-icon">Open Amount (FBD)</label>
                        <div class="input-group input-group-merge">
                            {{-- <span class="input-group-text"><i data-feather="user"></i></span> --}}
                            <input type="text" name="open_amount" id="open_amount_{{$key}}" class="form-control"
                                 autocomplete="false">
                        </div>
                    </td>
                    <td width="20%">
                        ...
                        <div class="input-group input-group-merge">
                            {{-- <span class="input-group-text"><i data-feather="user"></i></span> --}}
                            <select name="account_status" id="account_status_{{$key}}" class="is_mnp form-control" onchange="account_status('{{$key}}')">
                                <option value="" selected>Choose Status</option>
                                <option value="Open Amount" >Open Amount</option>
