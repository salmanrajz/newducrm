...
@else
                        ...
                        <div class="col-12">
                                <button type="button" class="btn btn-primary me-1"
                                    onclick="SavingActivationLead('{{ route('ResendMessage') }}', 'MyRoleForm','{{ route('ViewWapPending') }}')">Resend WhatsApp</button>
                                <button type="button" class="btn btn-success me-1"
                                    onclick="SavingActivationLead('{{ route('WhatsAppProceed') }}', 'MyRoleForm','{{ route('ViewWapPending') }}')">Send to Proceed</button>
                            </div>
                        @endif
