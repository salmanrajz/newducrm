            ...
            <div class="col-xl-4 col-sm-2 col-12 mb-2 mb-xl-0">
              <div class="d-flex flex-row">
                ...
                <div class="my-auto">
                  <h4 class="fw-bolder mb-0">
                    {{-- 0 --}}
                                {{$provider::MyWhatsAppCountFNE('Daily',auth()->user()->id,'5G_EXPIRED')}}
            ...
            <div class="col-xl-4 col-sm-2 col-12 mb-2 mb-xl-0">
              <div class="d-flex flex-row">
                ...
                <div class="my-auto">
                  <h4 class="fw-bolder mb-0">
                    {{-- 0 --}}
                                {{$provider::MyWhatsAppCountFNE('Weekly',auth()->user()->id,'5G_EXPIRED')}}
              ...
              <div class="d-flex flex-row">
                ...
                <div class="my-auto">
                  <h4 class="fw-bolder mb-0">
                    {{-- 0 --}}
                                {{-- {{$provider::MyWhatsAppCount('Follow up')}} --}}
                                {{$provider::MyWhatsAppCountFNE('Monthly',auth()->user()->id,'5G_EXPIRED')}}
