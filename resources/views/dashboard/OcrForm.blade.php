...
{{--
  <div class="container">
   ...
   @endif
   <form method="post" enctype="multipart/form-data" action="{{route('OcrFormSubmit')}}">
    {{ csrf_field() }}
    <div class="form-group">
     <table class="table">
      <tr>
       ...
       <td width="30">
        <input type="file" name="front_img[]" multiple />
       ...
       <td>
                <label for="CMID">CMID</label>
                <select name="salman" id="salman" class="form-control" required>
                    <option value="">Select First</option>
                    <option value="Rabi">Rabi</option>
                    <option value="New">Imran</option>
                    <option value="Adnan" selected>Adnan</option>
   ...
   <div class="form-group">
    <label for="CMID">CMID</label>
    <input type="text" name="cmid" id="cmid" class="form-control">
   </div>
   <div class="form-group">
   ...
   <div class="form-group">
    <label for="cname">Customer Number</label>
