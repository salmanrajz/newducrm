...
<head>
    <title>Import Follow Up DNC SOFTWARE</title>
...
<body onload="loc.getLocation()">
  ...
  <div class="container">
   ...
   @if(count($errors) > 0)
    ...
    @endphp --}}
   <form method="post" enctype="multipart/form-data" action="{{route('submit_dnc_number.follow')}}">
    ...
    {{-- <form method="post" enctype="multipart/form-data" action="{{route('dnc.add.number.new')}}"> --}}
        ...
        <div class="form-group">
            <table class="table">
                <tr>
                    <td width="40%" align="right"><label>Type Number FOR FOLLOW DNC
                            <p>
                                Limit 1 Number Only</p>
                        </label></td>
                    <td width="30">
                        <input type="tel" name="list" id="list" class="form-control" class="form-control">
                        {{-- <input type="text" name="dncr`" id="list" class="form-control" class="form-control"> --}}
