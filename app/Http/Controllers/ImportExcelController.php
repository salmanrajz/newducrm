...
use App\Imports\ImportCMID;
use App\Imports\ImportEti;
...
class ImportExcelController extends Controller
{
    ...
    //
    public function ImportExcelEti()
    {
        // return "b";
        return view('dashboard.importEti');
    }
    //
    //
    public function ImportExcelCMID()
    {
        // return "b";
        return view('dashboard.import_cmid');
    }
    //
    //
    public function SendTemplateWhatsApp()
    {
        // return "b";
        return view('dashboard.send-template-whatsapp');
    }
    //
    //
    public function SendTemplateWhatsAppSubmit(Request $request)
    {
        // return "b";
        for($i=0;$i<=10;$i++){
            // return $i;
            // $number = $request->contact_number;
            $number = '923123500256,971509419303,923313678032';
            \App\Http\Controllers\ReportController::InitiateWhatsAppVerification($number);
            // return view('dashboard.send-template-whatsapp');
             back()->with('success', 'Message Send Succesfully.' . $number . ' <= ');
        }
    ...
    public function OcrFormSubmit(Request $request){
        ...
        if ($file = $request->file('front_img')) {
            ...
            $multi_filePath = 'https://salmanrajzzdiag.blob.core.windows.net/vocus/DataScan/1716749392for-boss-hw-plus.png';
...
// return "al";
    ...
    //
    //
    public function importEti(Request $request){
        // return
        // return $request;
        $this->validate($request, [
            'select_file'  => 'required|mimes:xls,xlsx'
        ...
        // $data = Excel::Import(new $path);
        // Excel::import(new NumberImport, $path);
        Excel::import(new ImportEti, $path);
        // return "SSS";
        return back()->with('success', 'Number Data Imported successfullys.');
    }
    //
    //
    public function importCMID(Request $request){
        // return
        // return $request;
        $this->validate($request, [
            'select_file'  => 'required|mimes:xls,xlsx'
        ...
        // $data = Excel::Import(new $path);
        // Excel::import(new NumberImport, $path);
        Excel::import(new ImportCMID, $path);
        // return "SSS";
        return back()->with('success', 'Number Data Imported successfullys.');
    }
    //
